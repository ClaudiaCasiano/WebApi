...
namespace WebApi.Models.AB
{
    class Arbol2
    {
        ...
        public void print()
        {
            ...
            imprimir(principal);
            total = struc - 1;
            Console.WriteLine("el total de nodos es" + total);
            struc = 0;
            usados = 2;
        ...
        public void imprimir(Pagina raiz)
        {
            ...
            if (raiz.Ramas[0] != null)
            {
                Console.WriteLine("esta raiz tiene este numero de ramas " + raiz.Cuentas);
                Pagina ram;
                for (int i = 0; i < raiz.Cuentas + 1; i++)
                {
                    ram = raiz.Ramas[i];
        ...
        public void Rel(Pagina raiz)
        {
            ...
            for (int i = 0; i < raiz.Cuentas; i++)
            {
                Console.WriteLine(i + ". " + raiz.hijos.Dequeue());
            }
            ...
            //for (int i = 0; i < raiz.Cuentas; i++)
            //{
            //    Console.WriteLine("Se han usado " + usados);
        ...
        {
            struc++;
            Console.WriteLine("----------------------------------------------se va a entrar a relaciones :3");

            int k = 0;

            for (int i = 0; i <= raiz.Cuentas - 1; i++)
            {
                Console.WriteLine("los usado son  " + usados);
                if (usados <= total)
                {
                    Console.WriteLine("Se han usado " + usados);
